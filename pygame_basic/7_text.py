...
# 배경 이미지 불러오기
background = pygame.image.load("C:/Users/blued/git/PythonGames/pygame_basic/background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/blued/git/PythonGames/pygame_basic/character.png")
...
# 적(enemy) 캐릭터 불러오기 
enemy = pygame.image.load("C:/Users/blued/git/PythonGames/pygame_basic/enemy.png")
...
# 10 fps : 1초 동안에 10번 동작 -> 1번에 몇 만큼 이동?
    ...
    screen.blit(background, (0, 0)) # 로드한 이미지로 배경 그리기
